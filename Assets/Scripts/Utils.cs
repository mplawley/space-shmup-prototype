...
//=================================================BOUNDS FUNCTIONS=========================================\\
	...
	public static Vector3 BoundsInBoundsCheck(Bounds bigB, Bounds lilB, BoundsTest test = BoundsTest.onScreen)
	{
		...
		//Initialize the offset of [0, 0, 0]
...
//======================================= TRANSFORM FUNCTIONS ==============================================\\
	...
	//This function will iteratively climb up the transform.parent tree until it either finds a parent
	//with a tag != "Untagged" or no parent 
